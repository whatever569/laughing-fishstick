...
float temperaturesensor() {
	...
	const uint8_t command_params[2] = {0x33, 0x00};
    ...
    switch(state) {
        ...
        case 2: 
            ...
            delay_ms(10);
            //Send the 0xAC instruction (trigger measurement) after waiting 10ms. There are two bytes in this command parameter: 0x33 for the first byte and 0x00 for the second. 
